...
Table  omega(p,p)  Radau matrix
         p1        p2        p3        p4        p5
p1       0.0730    -0.0267   0.0187    -0.0129   0.0050
p2       0.1538    0.1462    -0.0364   0.0212    -0.0079
p3       0.1401    0.2990    0.1676    -0.0340   0.0109
p4       0.1449    0.2765    0.3258    0.1288    -0.0157
p5       0.1437    0.2814    0.3118    0.2231    0.0400
;
...
*===============================================================================
put results;
*put_utilities 'ren' / 'results\Radau_'seed.tl:0'.csv';
